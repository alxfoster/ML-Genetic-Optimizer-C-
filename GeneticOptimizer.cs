...
using System.Text;
using Platform.Core.FloatingPoint;

#endregion

namespace Platform. PlatScript.Optimizers
{
	public class GeneticOptimizer : Optimizer
	{
		...
		protected override void OnStateChange()
		{
			if (State == State.SetDefaults)
			{
				...
				Name						= Custom.Resource. PlatScriptOptimizerGenetic;
		...
		[Display(ResourceType = typeof(Custom.Resource), Name = " PlatScriptGeneticOptimizerConvergenceThreshold")]
		[Range(0, Int32.MaxValue)]
		public int	ConvergenceThreshold		{ get; set; }

		[Display(ResourceType = typeof(Custom.Resource), Name = " PlatScriptGeneticOptimizerCrossoverRatePercent")]
		[Range(0, 100)]
		...
		[Display(ResourceType = typeof(Custom.Resource), Name = " PlatScriptGeneticOptimizerGenerations")]
		[Range(1, Int32.MaxValue)]
		public int		Generations				{ get; set; }

		[Display(ResourceType = typeof(Custom.Resource), Name = " PlatScriptGeneticOptimizerGenerationSize")]
		[Range(1, Int32.MaxValue)]
		public int		GenerationSize			{ get; set; }

		[Display(ResourceType = typeof(Custom.Resource), Name = " PlatScriptGeneticOptimizerMinimumPerformance")]
		[Range(0, Int32.MaxValue)]
		public double	MinimumPerformance		{ get; set; }

		[Display(ResourceType = typeof(Custom.Resource), Name = " PlatScriptGeneticOptimizerMutationRatePercent")]
		[Range(0, 100)]
		...
		[Display(ResourceType = typeof(Custom.Resource), Name = " PlatScriptGeneticOptimizerMutationStrengthPercent")]
		[Range(0, 100)]
		...
		[Display(ResourceType = typeof(Custom.Resource), Name = " PlatScriptGeneticOptimizerResetSizePercent")]
		[Range(0, 100)]
		...
		[Display(ResourceType = typeof(Custom.Resource), Name = " PlatScriptGeneticOptimizerStabilitySizePercent")]
		[Range(0, 100)]
